...
if (!empty($_POST)){
    ...
    if (!empty($username) && $p1==$p2){
        $p1 = md5($p1);
        mysqli_query($link,"INSERT INTO 02_auth_admin (auth_name,auth_username,auth_email,auth_phone,auth_password,auth_file) values ('$name','$username','$email','$phone','$p1','$fileName')");
        header("location:officeAdminLogin.php");}
    ...
    <div class="row">
        <div class="col-md-6">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <p>Already have an account? <a href="officeAdminLogin.php">Log in</a></p>
            </form>
        </div>
    </div>
